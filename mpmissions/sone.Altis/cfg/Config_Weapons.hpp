...
class WeaponShops {
    ...
    class rebel {
        ...
        items[] = {
           // 5.56          
			...
			// 7.62
	        { "srifle_EBR_F","", 350000, -1 }, // MK18
			{ "srifle_DMR_01_F","", 300000, -1 }, // Rahim
			{ "arifle_AK12_F","", 300000, -1 }, // AK12
    ...
    class blackmarket {
        ...
        items[] = {
            // 5.56
            { "arifle_Mk20C_plain_F",   "", 120000, -1 }, // MK20C           
            { "arifle_SPAR_01_snd_F",   "", 150000, -1 }, // SPAR
			{ "arifle_AKS_F",           "", 100000, 5000 },
            { "arifle_SDAR_F",          "",   50000, 15000 -1 }, // SDAR
			{ "arifle_CTAR_ghex_F", "",   180000, 15000 -1 }, // CTAR
			{ "arifle_CTAR_blk_F", "",   180000, 15000 -1 }, // CTAR
			{ "arifle_CTAR_hex_F", "",   180000, 15000 -1 }, // CTAR
			
             // 6.5
			 { "arifle_MXC_F", "",   550000, 15000 -1 }, // MXC
			 { "arifle_ARX_ghex_F", "",   600000, 15000 -1 }, // arx
			 
			 
			// 7.62
            { "arifle_AKM_F",        "", 700000, -1 }, // AKM
			{ "srifle_DMR_06_camo_F","", 1400000, -1 }, // MK14
		...
		{ "30Rnd_556x45_Stanag",    "", 1000,   -1 }, // 5.56 Stanag
			...
			// 6.5
            { "30Rnd_65x39_caseless_mag",  "", 2500,   -1 }, // 6.5
			{ "20Rnd_650x39_Cased_Mag_F",    "", 2000,   -1 }, // 6.5
			{ "30Rnd_65x39_caseless_green",    "", 2000,   -1 }, // 6.5
			
			
			// 7.62
            { "20Rnd_762x51_Mag",    "", 1000,   -1 }, // MK1/MK1/MK14
			{ "10Rnd_762x54_Mag",    "", 1000,   -1 }, // Rahim
			{ "30Rnd_762x39_Mag_F",  "", 1000,   -1 }, // AKM/AK12
        ...
        accs[] = {
			...
			{ "muzzle_snds_65_TI_ghex_F",          "", 100000,   -1 }, // 6.5 Silencer
