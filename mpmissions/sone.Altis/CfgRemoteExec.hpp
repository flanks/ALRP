...
#include "maverick\maverick_remoteExec_master.cpp"
		...
		F(life_fnc_seizeWeapon,CLIENT)
		F(life_fnc_removeWeaponAction,CLIENT)
		
		
		//FDorce enter vehicles
		F(life_fnc_copEnter,CLIENT)
		
		//TAZERAGDOLL
		F(life_fnc_tazeRagdoll,CLIENT)
		
		//NEW cloth thingy
		F(life_fnc_HandleUniforms,CLIENT)
		F(life_fnc_ReTexBackpack,CLIENT)
		F(life_fnc_ReTexUniform,CLIENT)
		
		//Crush
		F(life_fnc_copCrush,CLIENT)
		F(life_fnc_vehicleIsDead,CLIENT)
        ...
        // Sounds
        F(life_fnc_handcuffSound,CLIENT) // Handcuff sound 
        F(life_fnc_ziptieSound,CLIENT) // Zipties Restrain Sound 
        F(life_fnc_knockoutSound,CLIENT) // Knockout Sound 
		...
		F(life_fnc_robStorage,CLIENT) // Rob shops
