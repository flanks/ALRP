...
/* System Settings */
    ...
    sendtoJail_locations[] = { "police_hq_1", "sendtojail_1", "sendtojail_2", "sendtojail_3", "sendtojail_4", "sendtojail_5", "police_hq_2", "cop_spawn_3", "cop_spawn_5", "Correctional_Facility", "Kavala_hq","Pyrgos_hq" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    seize_vest[] = { "V_TacVest_blk_POLICE", "V_TacVest_khk", "V_TacVestIR_blk", "V_PlateCarrier1_tna_F", "V_PlateCarrierL_CTRG", "V_TacVest_oli", "V_TacVest_blk", "V_TacVest_khk", "V_TacVest_camo", "V_PlateCarrier1_blk" }; //Any specific vests you want to be seized from players
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "O_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F","I_MRAP_03_F"}; //Vehicles that can only be rented and not purchased. (Last only for the session)
