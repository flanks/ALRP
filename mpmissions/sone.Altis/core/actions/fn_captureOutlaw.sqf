...
[[0,1],"<t color='#ff0000' size='1.6' shadow='1' font='PuristaBold' shadowColor='#000000' align='center'>WARNING</t> %1 and his gang: %2 - have taken control of the outlaw area!",true,[name player,(group player) getVariable "gang_name"]] remoteExecCall ["life_fnc_broadcast",0];
"Wasteland_1" setMarkerText format["Outlaw area controlled by %1", (group player) getVariable "gang_name"];
