...
[0,format[localize "STR_MISC_StPubIntox",profileName]] remoteExec ["life_fnc_broadcast",nil];
[getPlayerUID player,profileName,"390"] remoteExec ["life_fnc_wantedAdd",2];
};
