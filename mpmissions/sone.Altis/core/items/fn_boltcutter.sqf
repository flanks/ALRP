...
if (((nearestObject [[16767.3,13651.9,0],"Land_i_Barracks_V2_F"]) == _building || (nearestObject [[16767.3,13651.9,0],"Land_i_Barracks_V2_F"]) == _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
    hint format [localize "STR_Civ_NotEnoughCops",(LIFE_SETTINGS(getNumber,"minimum_cops"))]
};
if ((typeOf _building) == "null" && (nearestObject [[16767.3,13651.9,0],"null"]) getVariable ["locked",true]) exitWith {hint localize "STR_ISTR_Bolt_Exploit"};
...
if ((nearestObject [[16767.3,13651.9,0],"Land_i_Barracks_V2_F"]) == _building || (nearestObject [[16767.3,13651.9,0],"Land_i_Barracks_V2_F"]) == _building) then {
    
    [[1,2],"STR_ISTR_Bolt_AlertFed",true,[]] remoteExecCall ["life_fnc_broadcast",RCLIENT]; // Replaced with AAN
