...
(findDisplay 3100) displaySetEventHandler ["KeyDown","if ((_this select 1) isEqualTo 1) then {closeDialog 0; [player, true] call life_fnc_HandleUniforms;}"]; //Fix Custom Skin after ESC
