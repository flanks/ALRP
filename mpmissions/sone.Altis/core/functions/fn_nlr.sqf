...
hint "You seem to be violating the New Life Rule. If you just passing through it's all right but if there is an fight you can be warned or in worst case banned";
