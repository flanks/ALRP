...
if (_curObject isKindOf "House_F" && {player distance _curObject < 12} || ((nearestObject [[16767.3,13651.9,0],"Land_i_Barracks_V2_F"]) == _curObject || (nearestObject [[8614.38,10037.2,0],"Land_Research_house_V1_F"]) == _curObject)) exitWith {
