...
switch (playerSide) do
{
    ...
    case civilian: {
        ...
        if (_item in ["U_C_Poloshirt_blue","U_C_Poloshirt_burgundy","U_C_Poloshirt_stripped","U_C_Poloshirt_tricolour","U_C_Poloshirt_salmon","U_C_Poloshirt_redwhite","U_C_Commoner1_1","U_C_Scientist","U_B_CombatUniform_mcam_worn"]) then {
            [player, true] call life_fnc_HandleUniforms;
        };
    };
    case independent: {
