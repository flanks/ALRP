...
class playerSettings {
    ...
    class controls {
        ...
        /* class ButtonGroupMenu: Life_RscButtonMenu {
            idc = -1;
            text = "Groups";
            onButtonClick = "if(!isNull life_my_group) then { createDialog ""life_my_group_Diag""} else { createDialog ""Life_Group_Prompt""};";
            x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
            y = 0.805;
            w = (6.25 / 40);
            h = (1 / 25);
