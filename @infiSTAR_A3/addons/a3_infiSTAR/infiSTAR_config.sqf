...
*/
_serverCommandPassword = 'vinterkyla';
...
_ESCMNUTOP = 'www.secretone.net';
_ESCMNUBOT = 'ts.secretone.net';
...
_SHOW_TIMER_IN_MIN = [1,2,3,5,10,30,60];	/* minutes before restart, when message is shown */
...
/* ViewDistance Value   */ _VDV = 2600;
/* ObjectViewDistance   */ _VOV = 1600;
...
[
	[
		[
			'76561198013525274', // Flanks
			'76561197982234516', // Adolf
			'76561197990711602', // Danne
			'76561198106077549', // Criss
			'76561198024298765', // Soldier
			'76561197993671144', // Begravaren
			'76561197987754078', // Nicko
			'76561198033070283', // mongo seppo
			'76561197993098082'  // Vicious
		
		
		],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
			'Teleport - Target To Me','Teleport - Me To Target',
			'Delete Vehicle','spectating','Remove Gear','Revive','Eject','Eject Crew','God Mode',
			'Kick (Silent)','Kick (Announce)','ToggleVehLock','Ban (Silent)','God Mode','Ban (Announce)',
			'infiSTAR MapIcons','Mass Message','DayTime','NightTime','==== WeatherLord ===='
			,'==== Objects ====','==== VirtualItems ====','==== Bags ====','==== Vehicles ====','AdminLog','Spawn Support-Box1','Spawn Support-Box2','Spawn Support-Box3'
		]
	],
	[
...
_SupportBox1Content =
[
	['30Rnd_9x21_Green_Mag',200],['B_Parachute',40],['hgun_PDW2000_Holo_F',40]
];

_SupportBox2Content =
[
	['30Rnd_9x21_Green_Mag',200],['ItemGPS',5],'ItemWatch'
];

_SupportBox3Content =
[
	'ItemMap',['hgun_PDW2000_Holo_F',40],'ItemWatch'
];
/* ********************************************************************************* */
/* ********************************************************************************* */
/* ********************************************************************************* */
