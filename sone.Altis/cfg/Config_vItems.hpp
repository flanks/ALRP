...
class VirtualShops {
    ...
    class market {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "excavator","tongs","bottledBeer","bottledWhiskey","bottledShine","banana","waterBottle", "coconut", "rabbit", "apple", "redgull", "tbacon", "pickaxe", "toolkit", "fuelFull", "peach", "storagesmall", "storagebig", "rabbit_raw", "hen_raw", "rooster_raw", "sheep_raw", "goat_raw" };
    };
	...
	class antique {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "ruby","peach","doubloon","silverpiece","diamondCut" };
    };
    ...
    class med_market {
        ...
        license = "";
        level[] = { "", "", -1, "" };
        items[] = { "waterBottle", "coconut","rabbit", "apple", "redgull", "tbacon", "toolkit", "fuelFull", "peach", "defibrillator" };
    };
