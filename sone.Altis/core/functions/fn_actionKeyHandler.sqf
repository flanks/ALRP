...
if (_curObject isKindOf "House_F" && {player distance _curObject < 12} || ((nearestObject [[15811.9,16584.5,0],"Land_MilOffices_V1_F"]) == _curObject || (nearestObject [[8614.38,10037.2,0],"Land_Research_house_V1_F"]) == _curObject)) exitWith {
...
if (isPlayer _curObject && !dialog && _curObject isKindOf "Man" && (_curObject getVariable ["restrained",false]) ) then {
