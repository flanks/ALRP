...
/* Database Related Settings */
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","counterfitCash","busticket","gateopener" };
...
/* System Settings */
	...
	minimum_cops_bank = 3; //Minimum cops required online to rob the Bank
	
	/*Death settings*/
    drop_weapons_onDeath = true; //Set true to enable weapon dropping on death. False 
    ...
    clothing_masks[] = { "G_Balaclava_TI_blk_F","H_Shemag_olive", "H_Shemag_khk", "H_Shemag_tan", "H_Shemag_olive_hs", "H_ShemagOpen_khk", "H_ShemagOpen_tan", "G_Balaclava_combat", "G_Balaclava_lowprofile", "G_Balaclava_oli", "G_Bandanna_aviator", "G_Bandanna_beast", "G_Bandanna_blk", "G_Bandanna_khk", "G_Bandanna_oli", "G_Bandanna_shades", "G_Bandanna_sport", "G_Bandanna_tan", "U_O_GhillieSuit", "U_I_GhillieSuit", "U_B_GhillieSuit", "H_RacingHelmet_1_black_F", "H_RacingHelmet_1_red_F", "H_RacingHelmet_1_white_F", "H_RacingHelmet_1_blue_F", "H_RacingHelmet_1_yellow_F", "H_RacingHelmet_1_green_F", "H_RacingHelmet_1_F", "H_RacingHelmet_2_F", "H_RacingHelmet_3_F", "H_RacingHelmet_4_F" };
    ...
    restricted_uniforms[] = { "U_Rangemaster", "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn", "U_B_survival_uniform", "U_B_Protagonist_VR" };
    ...
    sendtoJail_locations[] = { "police_hq_1", "sendtojail_1", "sendtojail_2", "sendtojail_3", "sendtojail_4", "sendtojail_5", "police_hq_2", "cop_spawn_3", "cop_spawn_5", "Correctional_Facility", "Kavala_hq" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F","I_MRAP_03_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
...
#include "cfg\Config_Clothing.hpp"
#include "cfg\Config_Licenses.hpp"
#include "cfg\Config_Vehicles.hpp"
#include "cfg\Config_vItems.hpp"
#include "cfg\Config_Weapons.hpp"
#include "cfg\Config_Gather.hpp"
#include "cfg\Config_SpawnPoints.hpp"
#include "cfg\Config_Process.hpp"
