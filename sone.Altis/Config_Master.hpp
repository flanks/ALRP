...
/* System Settings */
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F","O_MRAP_02_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
