...
life_radio_emergencyservices = radioChannelCreate [[1,-1,-1, 0.5], "Emergency Services Channel", "%UNIT_NAME", []];
...
_dome = nearestObject [[15811.9,16584.5,0],"Land_MilOffices_V1_F"];
